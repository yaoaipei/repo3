...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>姚裴!租房网 - 用户登录</TITLE>
  ...
  <TR>
    ...
    <TD><!-- <input type="password" class="text" name="password" /> --><INPUT 
      id=user_password class=text type=password name=password> </TD></TR><!--
						...
						--></TBODY></TABLE>
<DIV class=buttons> <INPUT value=登陆 type=submit name="sub"> <INPUT onclick='document.location="regs.htm"' value=注册 type=button>
